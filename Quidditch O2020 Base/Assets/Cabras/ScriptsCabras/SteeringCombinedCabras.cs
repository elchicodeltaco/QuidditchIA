...
public class SteeringCombinedCabras : MonoBehaviour
{
    ...
    void Interpose()
    {
        ...
        Vector3 agent1Vel = agent1.GetComponent<SteeringCombinedCabras>() ? agent1.GetComponent<SteeringCombinedCabras>().Velocity : Vector3.zero;
        Vector3 agent2Vel = agent2.GetComponent<SteeringCombinedCabras>() ? agent2.GetComponent<SteeringCombinedCabras>().Velocity : Vector3.zero;
    ...
    void TeamSeparation()
    {
        ...
        SteeringForce += (Steering*10) * separationWeight;
    }
